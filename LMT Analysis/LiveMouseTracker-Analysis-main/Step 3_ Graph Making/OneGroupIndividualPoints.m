...
filenames = dir('/mnt/Data1/LMT/LMT_data/Genotypes/*.mat');
...
%SHANK2_KOs_SH
[~, ~, Shank2_KO_std1_m_SH_TotalFrames, Shank2_KO_std1_m_SH_TotalFrames_Each, ~]        = ComputeGroupData(Shank2_KO_std1_m_SH, Behaviours);


%%%Control animals (e.g. WT_SH (wild type standard housed))

%WTs_SH
[~, ~, Shank2_WT_std1_m_SH_SH_TotalFrames, Shank2_WT_std1_m_SH_SH_TotalFrames_Each, ~]                = ComputeGroupData(Shank2_WT_std1_m_SH,    Behaviours);
...
norm_Shank2_KO_std1_m_SH_TotalFrames = Shank2_KO_std1_m_SH_TotalFrames./Shank2_WT_std1_m_SH_SH_TotalFrames;
norm_Shank2_KO_std1_m_SH_TotalFrames_Each = Shank2_KO_std1_m_SH_TotalFrames_Each./Shank2_WT_std1_m_SH_SH_TotalFrames;

norm_Shank2_WT_std1_m_SH_SH_TotalFrames = Shank2_WT_std1_m_SH_SH_TotalFrames./Shank2_WT_std1_m_SH_SH_TotalFrames;
norm_Shank2_WT_std1_m_SH_SH_TotalFrames_Each = Shank2_WT_std1_m_SH_SH_TotalFrames_Each./ Shank2_WT_std1_m_SH_SH_TotalFrames;

%% Section 5: Calculate STD/SEM of data

% Test animals (to be displayed as error bars on the graph)
norm_Shank2_KO_std1_m_SH_TotalFrames_std = std(norm_Shank2_KO_std1_m_SH_TotalFrames_Each,1);
norm_Shank2_KO_std1_m_SH_TotalFrames_sem = std(norm_Shank2_KO_std1_m_SH_TotalFrames_Each,1)/sqrt(length(norm_Shank2_KO_std1_m_SH_TotalFrames_Each));

% Control animals (to be displayed as a shaded grey region behind the bars)
norm_Shank2_WT_std1_m_SH_SH_TotalFrames_std = std(norm_Shank2_WT_std1_m_SH_SH_TotalFrames_Each,1);
norm_Shank2_WT_std1_m_SH_SH_TotalFrames_sem = std(norm_Shank2_WT_std1_m_SH_SH_TotalFrames_Each,1)/sqrt(length(norm_Shank2_WT_std1_m_SH_SH_TotalFrames_Each));


%%% this piece of code just sets up the grey region:
greyRegion_Data_std = [norm_Shank2_WT_std1_m_SH_SH_TotalFrames; (norm_Shank2_WT_std1_m_SH_SH_TotalFrames+norm_Shank2_WT_std1_m_SH_SH_TotalFrames_std); (norm_Shank2_WT_std1_m_SH_SH_TotalFrames-norm_Shank2_WT_std1_m_SH_SH_TotalFrames_std)];
...
greyRegion_Data_sem = [norm_Shank2_WT_std1_m_SH_SH_TotalFrames; (norm_Shank2_WT_std1_m_SH_SH_TotalFrames+norm_Shank2_WT_std1_m_SH_SH_TotalFrames_sem); (norm_Shank2_WT_std1_m_SH_SH_TotalFrames-norm_Shank2_WT_std1_m_SH_SH_TotalFrames_sem)];
...
% Change the following variables according:
 ...
 errorBar_testData = norm_Shank2_KO_std1_m_SH_TotalFrames_std;
...
er = errorbar(norm_Shank2_KO_std1_m_SH_TotalFrames, errorBar_testData, 'k.', 'Marker', 'none')    %% Change here to display STD/SEM!!!
hold on;

%%Scatter plot:
for i = 1:size(norm_Shank2_KO_std1_m_SH_TotalFrames_Each,1)
    s(1) = scatter(x, norm_Shank2_KO_std1_m_SH_TotalFrames_Each(i,:), 50, 'ko')
    hold on
end
