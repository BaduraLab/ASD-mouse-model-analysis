%% README %%
%======================== Script: Making Graphs of Two Genotype norm. to another ========================%

% This code displays data relating to two datasets, normalised to another
% dataset (e.g. behaviour of Shank standard housed, enriced housed mice, 
% norm. to wild type standard housed mice). This code will display each 
% behaviour of the "test" genotype/group in two colours, and in the background 
...
% Plot graph
GraphDataTwo( Title, Legend, YLabel, greyRegion_Data_std, Behaviours, norm_S2_KOs_std1_SH_TotalFrames, norm_S2_KOs_std1_EE_TotalFrames, norm_S2_KOs_std1_SH_TotalFrames_std, norm_S2_KOs_std1_EE_TotalFrames_std )
